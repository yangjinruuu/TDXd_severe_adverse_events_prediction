...
def main() -> None:
    ...
    st.sidebar.markdown(
        "<div class='about-card'>After entering the relevant patient parameters, the system estimates the probability of TDXd-related severe adverse events. The model is intended to support risk stratification and should complement, rather than replace, clinical judgment. A low predicted risk does not mean that adverse events cannot occur.</div>",
        unsafe_allow_html=True,
    )
